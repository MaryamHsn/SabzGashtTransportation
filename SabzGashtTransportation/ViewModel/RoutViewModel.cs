    ...
    public class RoutViewModel
    {
      ...
      //  public string Name { get; set; }
       ...
       public int HasCoolerEnterMiniBus { get; set; }
        ...
        public int RoutTransactionSingle { get; set; }
        public int RoutTransactionRegular { get; set; }
        public int RoutTransactionThereeFour { get; set; }
        public int RoutTransactionFiveSeven { get; set; }
